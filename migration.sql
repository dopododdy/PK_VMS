...
FROM (VALUES
  ( 'Acepromazine', 'อะซีโพรมาซีน', 'TakeHome', 'General', 10,
    'เม็ด', 25, 'อาจทำให้ความดันโลหิตต่ำ ระวังในสัตว์ที่ตกเลือดหรือช็อก เพศผู้อาจเกิดภาวะ Paraphimosis',
  ...
  ( 'Acetaminophen', 'อะเซตามิโนเฟน (พาราเซตามอล)', 'TakeHome', 'General', 500,
    'เม็ด', 3, 'ห้ามใช้ในแมวโดยเด็ดขาด เป็นพิษถึงชีวิต ทำให้เกิด Methemoglobinemia และ Hepatic necrosis ในสุนัขระวังตับเสียหาย ไม่ใช่ยาแก้ปวดตัวเลือกแรก',
  ...
  ( 'Acetazolamide', 'อะซีตาโซลาไมด์', 'TakeHome', 'General', 250,
    'เม็ด', 20, 'อาจทำให้ Metabolic acidosis ไม่อยากอาหาร อ่อนแรง ตรวจ Electrolytes ระหว่างการรักษา',
  ...
  ( 'Acetylcysteine', 'อะเซทิลซิสทีน', 'TakeHome', 'General', 600,
    'เม็ด', 30, 'อาจทำให้คลื่นไส้ อาเจียน มีกลิ่นเหม็น ใช้เป็น Antidote สำหรับ Acetaminophen toxicity และ Hepatoprotectant',
  ...
  ( 'Acitretin', 'อะซิทรีติน', 'TakeHome', 'General', 25,
    'แคปซูล', 150, 'ห้ามใช้ในสัตว์ตั้งท้อง (Teratogenic อย่างรุนแรง) ตรวจ Liver enzymes และ CBC เป็นระยะ อาจทำให้ผิวแห้งและผมร่วง',
  ...
  ( 'Acyclovir', 'อะไซโคลเวียร์', 'TakeHome', 'General', 200,
    'เม็ด', 15, 'อาจทำให้ไตเสียหาย ให้น้ำเพียงพอระหว่างการรักษา ในแมวขนาดสูงอาจเป็นพิษ ต้องตรวจไตก่อนและระหว่างใช้',
  ...
  ( 'Afoxolaner', 'อะฟอกโซลาเนอร์', 'TakeHome', 'General', 1,
    'chewable', 200, 'ไม่ได้รับการอนุมัติสำหรับแมว ในสุนัขอาจทำให้อาเจียน ท้องเสีย เบื่ออาหาร ระวังในสุนัขที่มีประวัติชัก',
  ...
  ( 'Albendazole', 'อัลเบนดาโซล', 'TakeHome', 'General', 200,
    'เม็ด', 10, 'ห้ามใช้ในสัตว์ตั้งท้อง (Teratogenic) ในแมวอาจทำให้กดไขกระดูก ตรวจ CBC ระหว่างการรักษา',
  ...
  ( 'Alendronate', 'อะเลนโดรเนต', 'TakeHome', 'General', 10,
    'เม็ด', 30, 'ให้ขณะท้องว่างด้วยน้ำปริมาณมาก ห้ามนอนทันทีหลังให้ยาอย่างน้อย 30 นาที อาจทำให้หลอดอาหารอักเสบ',
  ...
  ( 'Altrenogest', 'อัลทรีโนเจสต์', 'TakeHome', 'General', 1,
    'mL', 200, 'ระวังการสัมผัสผ่านผิวหนัง สวมถุงมือเมื่อจัดการ เป็นอันตรายต่อหญิงตั้งครรภ์ ห้ามใช้ในสัตว์ที่มีปัญหาตับ',
  ...
  ( 'Amantadine', 'อะแมนทาดีน', 'TakeHome', 'General', 100,
    'แคปซูล', 20, 'อาจทำให้กระสับกระส่าย ท้องเสีย เบื่ออาหาร ใช้เสริม NSAIDs สำหรับ Chronic pain / Neuropathic pain',
  ...
  ( 'Aminocaproic acid', 'อะมิโนคาโพรอิก แอซิด', 'TakeHome', 'General', 500,
    'เม็ด', 30, 'อาจทำให้คลื่นไส้ อาเจียน ท้องเสีย ระวังในสัตว์ที่มีประวัติ Thromboembolism',
  ...
  ( 'Amiodarone', 'อะมิโอดาโรน', 'TakeHome', 'General', 200,
    'เม็ด', 50, 'อาจทำให้ตับเสียหาย ต่อมไทรอยด์ผิดปกติ ปอดอักเสบ ผิวหนังไวต่อแสง ตรวจ CBC Biochem และ Thyroid ก่อนและระหว่างใช้',
  ...
  ( 'Amlodipine', 'แอมโลดิพีน', 'TakeHome', 'General', 5,
    'เม็ด', 10, 'อาจทำให้ความดันโลหิตต่ำ อาการบวมที่แขนขา เฝ้าระวังความดันโลหิตระหว่างการรักษา',
  ...
  ( 'Amoxicillin', 'อะม็อกซิซิลลิน', 'TakeHome', 'General', 250,
    'เม็ด', 15, 'แจ้งสัตวแพทย์หากสัตว์มีประวัติแพ้ยากลุ่ม Penicillin อาจทำให้คลื่นไส้และท้องเสีย',
  ...
  ( 'Amoxicillin/Clavulanate', 'อะม็อกซิซิลลิน/คลาวิวลาเนต', 'TakeHome', 'General', 250,
    'เม็ด', 25, 'ควรให้พร้อมอาหารเพื่อลดคลื่นไส้ แจ้งสัตวแพทย์หากสัตว์มีประวัติแพ้ Penicillin',
  ...
  ( 'Ampicillin', 'แอมพิซิลลิน', 'TakeHome', 'General', 250,
    'แคปซูล', 10, 'แจ้งสัตวแพทย์หากสัตว์มีประวัติแพ้ Penicillin การดูดซึมทางปากต่ำกว่า Amoxicillin',
  ...
  ( 'Amprolium', 'แอมโพรเลียม', 'TakeHome', 'General', 10,
    'mL', 80, 'อาจทำให้ขาด Thiamine (Vitamin B1) หากใช้นานเกินไป อาการแสดงทางระบบประสาท ให้ Thiamine เสริมหากจำเป็น',
  ...
  ( 'Ascorbic acid', 'วิตามิน ซี (กรดแอสคอร์บิก)', 'TakeHome', 'General', 500,
    'เม็ด', 3, 'ขนาดสูงอาจทำให้ท้องเสียและ Oxalate urolithiasis ระวังในสัตว์ที่มีประวัตินิ่วในไต',
  ...
  ( 'Aspirin', 'แอสไพริน', 'TakeHome', 'General', 325,
    'เม็ด', 2, 'แมวเมแทบอลิซึมแอสไพรินช้ากว่ามาก ต้องให้ทุก 48-72 ชั่วโมงเท่านั้น อาจทำให้ GI ulcer และ GI bleeding',
    10.0, 'Antiplatelet / Mild pain (q12h ให้ร่วมอาหาร)', 25.0, 'Fever / Inflammation (q12h)',
    10.0, 'Antiplatelet — ระมัดระวัง ใช้เฉพาะ q48-72h เท่านั้น', NULL, NULL ),
  ...
  ( 'Avermectin', 'อะเวอร์เมกติน (ไอเวอร์เมกติน)', 'TakeHome', 'General', 1,
    'เม็ด', 50, 'ห้ามใช้ในพันธุ์สุนัขที่มียีน MDR1 mutation (Collie, Sheltie, Border Collie, Shetland Sheepdog) อาจทำให้ชัก อัมพาต และตายได้',
  ...
  ( 'Azathioprine', 'อาซาไธโอพรีน', 'TakeHome', 'General', 50,
    'เม็ด', 20, 'ห้ามใช้ในแมวโดยเด็ดขาด ทำให้กดไขกระดูกรุนแรงและเป็นอันตรายถึงชีวิต ในสุนัขตรวจ CBC ทุก 1-2 สัปดาห์ อาจทำให้ตับเสียหาย',
  ...
  ( 'Azithromycin', 'อะซิโทรมัยซิน', 'TakeHome', 'General', 250,
    'เม็ด', 30, 'อาจทำให้คลื่นไส้ อาเจียน ท้องเสีย ให้ร่วมหรือก่อนอาหารเพื่อลดผลข้างเคียง GI ระวัง QT prolongation',
  ...
  ( 'Baclofen', 'แบคโลเฟน', 'TakeHome', 'General', 10,
    'เม็ด', 10, 'อาจทำให้ง่วงซึม อาเจียน กล้ามเนื้ออ่อนแรง ในแมวอาจเป็นพิษในขนาดสูง ระวังในสัตว์ที่มีปัญหาไต',
  ...
  ( 'Barium sulfate', 'แบเรียมซัลเฟต', 'TakeHome', 'General', 100,
    'mL', 100, 'ห้ามใช้หากสงสัย GI perforation หรือ Obstruction อาจทำให้ท้องผูกและสำลักได้ ใช้เพื่อ Radiographic contrast เท่านั้น',
  ...
  ( 'Benazepril', 'เบนาซีพริล', 'TakeHome', 'General', 5,
    'เม็ด', 15, 'อาจทำให้ความดันโลหิตต่ำ Hyperkalemia ตรวจ Renal function และ Electrolytes เป็นระยะ',
  ...
  ( 'Bethanechol', 'เบทาเนโคล', 'TakeHome', 'General', 5,
    'เม็ด', 20, 'อาจทำให้คลื่นไส้ น้ำลายไหลมาก ท้องเสีย ปัสสาวะบ่อย ห้ามใช้หาก GI หรือ Urinary obstruction',
  ...
  ( 'Bisacodyl', 'บิซาโคดิล', 'TakeHome', 'General', 5,
    'เม็ด', 3, 'อาจทำให้ปวดท้อง ท้องเสีย สูญเสีย Electrolytes ไม่ควรใช้ยาวนาน ห้ามให้พร้อมยาลดกรด',
  ...
  ( 'Bismuth subsalicylate', 'บิสมัทซับซาลิไซเลต', 'TakeHome', 'General', 262,
    'เม็ด', 10, 'ระวังในแมวอย่างมาก มีซาลิไซเลตซึ่งเป็นพิษต่อแมว อาจทำให้อุจจาระและลิ้นดำชั่วคราว ระวังร่วมกับ Aspirin',
  ...
  ( 'Buspirone', 'บัสไพโรน', 'TakeHome', 'General', 10,
    'เม็ด', 15, 'อาจทำให้ง่วงซึม กระสับกระส่าย ระวังร่วมกับ MAOIs หรือ Serotonin-affecting drugs ใช้เวลาหลายสัปดาห์เพื่อเห็นผล',
  ...
  ( 'Busulfan', 'บัสซัลแฟน', 'TakeHome', 'General', 2,
    'เม็ด', 200, 'ยาเคมีบำบัด อาจทำให้กดไขกระดูกรุนแรง ต้องตรวจ CBC อย่างน้อยทุกสัปดาห์ สวมถุงมือเมื่อจัดการยา',
  ...
  ( 'Butorphanol', 'บิวทอร์ฟานอล', 'TakeHome', 'General', 1,
    'เม็ด', 30, 'อาจทำให้ง่วงซึม คลื่นไส้ ระวังในสัตว์ที่มีปัญหาทางเดินหายใจ ประสิทธิภาพต่ำเมื่อให้ทางปาก',
  ...
  ( 'Cabergoline', 'คาเบอร์โกลีน', 'TakeHome', 'General', 0.5,
    'เม็ด', 200, 'อาจทำให้คลื่นไส้ อาเจียน เบื่ออาหาร ระวังในสัตว์ที่มีปัญหาตับหรือไต ห้ามใช้ในสัตว์ตั้งท้องที่ต้องการคงการตั้งท้อง',
  ...
  ( 'Calcitriol', 'แคลซิไทรออล', 'TakeHome', 'General', 0.00025,
    'แคปซูล', 50, 'ระวัง Hypercalcemia ต้องตรวจ Ca2+ ในเลือดเป็นระยะ ขนาดสูงอาจทำให้ไตเสียหายจาก Calcium deposit',
    NULL, 'CKD Secondary hyperparathyroidism — 2.5-3.5 ng/kg (q24h) ตรวจ Ca2+ สม่ำเสมอ', NULL, NULL,
    NULL, 'Hypoparathyroidism / CKD — 2.5 ng/kg (q24h) ตรวจ Ca2+ สม่ำเสมอ', NULL, NULL ),
  ...
  ( 'Capromorelin', 'คาโปรโมเรลิน', 'TakeHome', 'General', 30,
    'mL', 500, 'อาจทำให้คลื่นไส้ อาเจียน เซื่องซึม ระวังใน Diabetes mellitus เพราะเพิ่ม GH/IGF-1',
  ...
  ( 'Carprofen', 'คาร์โพรเฟน', 'TakeHome', 'General', 25,
    'เม็ด', 30, 'ระวัง GI ulcer ตับเสียหาย ไตเสียหาย ตรวจ CBC และ Biochemistry ก่อนและระหว่างการรักษา',
  ...
  ( 'Cefaclor', 'เซฟาคลอร์', 'TakeHome', 'General', 250,
    'แคปซูล', 20, 'อาจทำให้คลื่นไส้ อาเจียน ท้องเสีย แจ้งสัตวแพทย์หากสัตว์มีประวัติแพ้ Cephalosporin หรือ Penicillin',
    20.0, 'Bacterial infections (q8h)', NULL, NULL,
    20.0, 'Bacterial infections (q8h)', NULL, NULL ),
  ( 'Cefadroxil', 'เซฟาโดรซิล', 'TakeHome', 'General', 500,
    'แคปซูล', 25, 'อาจทำให้คลื่นไส้ อาเจียน ท้องเสีย แจ้งสัตวแพทย์หากสัตว์มีประวัติแพ้ Cephalosporin',
    22.0, 'Skin / UTI infections (q12h)', NULL, NULL,
    22.0, 'Skin / UTI infections (q12h)', NULL, NULL ),
  ( 'Cefdinir', 'เซฟดินีร์', 'TakeHome', 'General', 300,
    'แคปซูล', 40, 'อาจทำให้คลื่นไส้ ท้องเสีย สีแดงในอุจจาระ (ไม่ใช่เลือด) แจ้งสัตวแพทย์หากแพ้ Cephalosporin',
  ...
  ( 'Cefixime', 'เซฟิกซีม', 'TakeHome', 'General', 100,
    'เม็ด', 30, 'อาจทำให้คลื่นไส้ ท้องเสีย ปวดท้อง แจ้งสัตวแพทย์หากแพ้ Cephalosporin',
  ...
  ( 'Cefpodoxime', 'เซฟโปดอกซีม', 'TakeHome', 'General', 100,
    'เม็ด', 50, 'อาจทำให้คลื่นไส้ ท้องเสีย ให้ร่วมอาหาร แจ้งสัตวแพทย์หากแพ้ Cephalosporin',
  ...
  ( 'Cephalexin', 'เซฟาเล็กซิน', 'TakeHome', 'General', 500,
    'แคปซูล', 15, 'อาจทำให้คลื่นไส้ ท้องเสีย แจ้งสัตวแพทย์หากแพ้ Cephalosporin',
  ...
  ( 'Chlorambucil', 'คลอแรมบิวซิล', 'TakeHome', 'General', 2,
    'เม็ด', 150, 'ยาเคมีบำบัด อาจทำให้กดไขกระดูก คลื่นไส้ ชักในขนาดสูง ตรวจ CBC ทุก 1-2 สัปดาห์ สวมถุงมือเมื่อจัดการยา',
  ...
  ( 'Chloramphenicol', 'คลอแรมเฟนิคอล', 'TakeHome', 'General', 250,
    'แคปซูล', 10, 'ห้ามสัมผัสโดยหญิงตั้งครรภ์ อาจทำให้กดไขกระดูก (โดยเฉพาะในแมว) ตรวจ CBC เป็นระยะ',
  ...
  ( 'Chlorpheniramine', 'คลอร์เฟนิรามีน', 'TakeHome', 'General', 4,
    'เม็ด', 3, 'อาจทำให้ง่วงซึม ปากแห้ง ปัสสาวะคั่ง ระวังในสัตว์ที่มีปัญหาต่อมลูกหมากหรือต้อหิน',
  ...
  ( 'Chlortetracycline', 'คลอร์เตตราไซคลีน', 'TakeHome', 'General', 250,
    'เม็ด', 10, 'ห้ามใช้ในสัตว์อายุน้อย (ทำให้ฟันและกระดูกเปลี่ยนสี) อาจทำให้ GI upset ให้ร่วมอาหาร',
  ...
  ( 'Ciprofloxacin', 'ไซโพรฟลอกซาซิน', 'TakeHome', 'General', 500,
    'เม็ด', 15, 'ห้ามใช้ในสัตว์ที่กระดูกยังไม่โต อาจทำให้ Cartilage เสียหาย ในแมวระวังขนาดสูงอาจทำให้ Retinal degeneration',
  ...
  ( 'Cisapride', 'ซิซาไพรด์', 'TakeHome', 'General', 5,
    'เม็ด', 25, 'อาจทำให้ท้องเสีย ปวดท้อง QT prolongation ระวังร่วมกับยาที่ยับยั้ง CYP3A4',
  ...
  ( 'Clarithromycin', 'คลาริโทรมัยซิน', 'TakeHome', 'General', 250,
    'เม็ด', 30, 'อาจทำให้คลื่นไส้ อาเจียน ท้องเสีย ปวดท้อง ระวัง Drug interactions (inhibits CYP3A4)',
  ...
  ( 'Clemastine', 'คลีมาสตีน', 'TakeHome', 'General', 1,
    'เม็ด', 10, 'อาจทำให้ง่วงซึม ปากแห้ง ปัสสาวะคั่ง เป็น H1 antihistamine สำหรับ Allergy',
  ...
  ( 'Clindamycin', 'คลินดาไมซิน', 'TakeHome', 'General', 75,
    'แคปซูล', 20, 'อาจทำให้คลื่นไส้ อาเจียน ท้องเสีย ให้น้ำมากพร้อมยา อาจทำให้ Antibiotic-associated colitis',
  ...
  ( 'Clomipramine', 'โคลมิพรามีน', 'TakeHome', 'General', 25,
    'เม็ด', 15, 'อาจทำให้ง่วงซึม ปากแห้ง ปัสสาวะคั่ง หัวใจเต้นผิดจังหวะ ระวังร่วมกับ MAOIs',
  ...
  ( 'Clonidine', 'โคลนิดีน', 'TakeHome', 'General', 0.1,
    'เม็ด', 10, 'อาจทำให้ง่วงซึม ความดันโลหิตต่ำ หัวใจเต้นช้า ห้ามหยุดยาทันที',
  ...
  ( 'Clopidogrel', 'โคลพิโดเกรล', 'TakeHome', 'General', 75,
    'เม็ด', 50, 'อาจทำให้เลือดออกได้ง่าย ห้ามร่วมกับ NSAIDs หรือ Aspirin โดยไม่ระวัง ระวังในสัตว์ที่ต้องผ่าตัด',
  ...
  ( 'Cloxacillin', 'โคลซาซิลลิน', 'TakeHome', 'General', 250,
    'แคปซูล', 15, 'แจ้งสัตวแพทย์หากสัตว์มีประวัติแพ้ Penicillin ใช้สำหรับ Staphylococcal infections โดยเฉพาะ',
  ...
  ( 'Codeine', 'โคดีน', 'TakeHome', 'General', 30,
    'เม็ด', 20, 'ไม่แนะนำในแมวเนื่องจากเมแทบอลิซึมที่แตกต่าง มีความเสี่ยงต่อพิษ อาจทำให้ง่วงซึม ท้องผูก หายใจช้าในสุนัข',
  ...
  ( 'Colchicine', 'โคลชิซีน', 'TakeHome', 'General', 0.5,
    'เม็ด', 20, 'อาจทำให้คลื่นไส้ อาเจียน ท้องเสีย อาจยับยั้งการทำงานของไขกระดูกในขนาดสูง ตรวจ CBC เป็นระยะ',
  ...
  ( 'Cyclophosphamide', 'ไซโคลฟอสฟาไมด์', 'TakeHome', 'General', 50,
    'เม็ด', 100, 'ยาเคมีบำบัด อาจทำให้กดไขกระดูก Hemorrhagic cystitis ต้องดื่มน้ำมาก ตรวจ CBC บ่อยๆ สวมถุงมือเมื่อจัดการ',
  ...
  ( 'Cyclosporine', 'ไซโคลสปอริน', 'TakeHome', 'General', 25,
    'แคปซูล', 80, 'ควรให้ขณะท้องว่างเพื่อดูดซึมที่ดี อาจทำให้คลื่นไส้ อาเจียน เหงือกงอก (Gingival hyperplasia) ระวัง Drug interactions',
  ...
  ( 'Danazol', 'ดาโนโซล', 'TakeHome', 'General', 100,
    'แคปซูล', 80, 'อาจทำให้ตับเสียหาย น้ำหนักเพิ่ม Virilization ในเพศเมีย ตรวจ Liver enzymes เป็นระยะ',
  ...
  ( 'Dantrolene', 'แดนโทรลีน', 'TakeHome', 'General', 25,
    'แคปซูล', 50, 'อาจทำให้ง่วงซึม กล้ามเนื้ออ่อนแรง ตับเสียหายในขนาดสูง ตรวจ Liver enzymes ระหว่างใช้',
  ...
  ( 'Dapsone', 'แดปโซน', 'TakeHome', 'General', 50,
    'เม็ด', 20, 'ห้ามใช้ในแมวโดยเด็ดขาด เป็นพิษอย่างรุนแรง ทำให้ Methemoglobinemia ในสุนัขตรวจ CBC เป็นระยะ ระวัง Hemolytic anemia',
  ...
  ( 'Deracoxib', 'เดราโคซีบ', 'TakeHome', 'General', 25,
    'เม็ด', 40, 'ระวัง GI ulcer ตับเสียหาย ไตเสียหาย ตรวจ Biochemistry ก่อนและระหว่างการรักษา ไม่แนะนำในแมว',
  ...
  ( 'Diazoxide', 'ไดอาโซกไซด์', 'TakeHome', 'General', 50,
    'แคปซูล', 100, 'อาจทำให้ Hyperglycemia Sodium/Water retention เบื่ออาหาร ตรวจน้ำตาลเลือดระหว่างการรักษา',
  ...
  ( 'Dicloxacillin', 'ไดโคลซาซิลลิน', 'TakeHome', 'General', 250,
    'แคปซูล', 15, 'แจ้งสัตวแพทย์หากสัตว์มีประวัติแพ้ Penicillin ใช้สำหรับ Penicillinase-producing Staphylococci',
  ...
  ( 'Diethylstilbestrol', 'ไดเอทิลสทิลเบสทรอล (DES)', 'TakeHome', 'General', 1,
    'เม็ด', 30, 'อาจทำให้กดไขกระดูก Pyometra ในเพศเมีย ระวังการใช้ระยะยาว ตรวจ CBC เป็นระยะ',
    NULL, 'Urinary incontinence — ขนาดคงที่ 0.1-1 mg/dog q24h (สุนัขเพศเมีย)', NULL, NULL,
    NULL, 'ไม่ค่อยใช้ในแมว — ปรึกษาสัตวแพทย์', NULL, NULL ),
  ( 'Digoxin', 'ไดจอกซิน', 'TakeHome', 'General', 0.125,
    'เม็ด', 20, 'ยาดัชนีการรักษาแคบมาก ต้องตรวจ Digoxin level เป็นระยะ อาการพิษ: คลื่นไส้ อาเจียน หัวใจเต้นผิดจังหวะ',
  ...
  ( 'Dihydrotachysterol', 'ไดไฮโดรทาคิสเทอรอล', 'TakeHome', 'General', 0.125,
    'แคปซูล', 80, 'ระวัง Hypercalcemia ต้องตรวจ Ca2+ ในเลือดเป็นระยะ ขนาดสูงทำให้ไตเสียหายจาก Calcium deposit',
  ...
  ( 'Diltiazem', 'ดิลไทอาเซม', 'TakeHome', 'General', 30,
    'เม็ด', 10, 'อาจทำให้หัวใจเต้นช้าและความดันโลหิตต่ำ ระวังในสัตว์ที่มีหัวใจล้มเหลว AV block',
  ...
  ( 'Diphenoxylate', 'ไดเฟนอกซีเลต', 'TakeHome', 'General', 2.5,
    'เม็ด', 10, 'ห้ามใช้หาก Infectious diarrhea สงสัย อาจทำให้ท้องผูก ไม่แนะนำในแมว อาจทำให้ CNS depression',
  ...
  ( 'Docusate sodium', 'โดคิวเสต โซเดียม', 'TakeHome', 'General', 100,
    'แคปซูล', 5, 'อาจทำให้ท้องเสียหากใช้มากเกิน ห้ามให้ร่วมกับ Mineral oil เพราะเพิ่มการดูดซึมของน้ำมัน',
  ...
  ( 'Domperidone', 'โดมเพอริโดน', 'TakeHome', 'General', 10,
    'เม็ด', 10, 'อาจทำให้ท้องเสีย ปวดท้อง ง่วงซึม ระวัง QT prolongation',
  ...
  ( 'Doxepin', 'ดอกซีพิน', 'TakeHome', 'General', 10,
    'แคปซูล', 20, 'อาจทำให้ง่วงซึม ปากแห้ง ปัสสาวะคั่ง หัวใจเต้นผิดจังหวะ ระวังร่วมกับ MAOIs',
  ...
  ( 'Doxycycline', 'ด็อกซีไซคลีน', 'TakeHome', 'General', 100,
    'เม็ด', 15, 'ให้พร้อมอาหารและน้ำเสมอเพื่อป้องกัน Esophageal stricture โดยเฉพาะในแมว ห้ามใช้ในสัตว์ตั้งท้องและสัตว์อายุน้อย',
  ...
  ( 'Enalapril', 'อีนาลาพริล', 'TakeHome', 'General', 5,
    'เม็ด', 10, 'อาจทำให้ความดันโลหิตต่ำ Hyperkalemia ตรวจ Renal function และ Electrolytes เป็นระยะ',
  ...
  ( 'Enrofloxacin', 'เอนโรฟลอกซาซิน', 'TakeHome', 'General', 50,
    'เม็ด', 20, 'ห้ามใช้ในแมวเกิน 5 mg/kg/day เสี่ยงต่อ Retinal degeneration (ตาบอด) ห้ามใช้ในสัตว์ที่กระดูกยังไม่โต',
  ...
  ( 'Ephedrine', 'อีเฟดรีน', 'TakeHome', 'General', 25,
    'เม็ด', 20, 'อาจทำให้หัวใจเต้นเร็ว ความดันโลหิตสูง กระสับกระส่าย ระวังในสัตว์ที่มีโรคหัวใจหรือความดันสูง',
  ...
  ( 'Erythromycin', 'อีริโทรมัยซิน', 'TakeHome', 'General', 250,
    'เม็ด', 10, 'อาจทำให้คลื่นไส้ อาเจียน ท้องเสีย ปวดท้อง ให้ร่วมอาหาร ขนาดต่ำใช้เป็น Prokinetic',
